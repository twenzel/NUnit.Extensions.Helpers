...
""");
		...
		generatorResult.Diagnostics.Should().Contain(d => d.Id == "NEG101" && d.ToString() == "error NEG101: The class Testing.CtorTests should be partial");
	}
...
""");
		...
		var generatorResult = TestHelpers.GenerateCSharpOutput<ConstructorParameterNullTestGenerator>(inputCompilation);
		generatorResult.Diagnostics.Should().NotBeEmpty();
		generatorResult.Diagnostics.Should().Contain(d => d.Id == "NEG101" && d.ToString() == "error NEG101: The class Testing.OtherTest.CtorTests should be partial");
	}
...
""");
		...
		generatorResult.GeneratedSources[0].HintName.Should().StartWith("Testing.MyTests_");
		generatorResult.GeneratedSources[0].SourceText.ToString().Trim().Should().Be("""
// <auto-generated/>
using System;
using FluentAssertions;
